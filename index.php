...
<body class="animsition">
	...
	<section class="slide1">
		<div class="wrap-slick1">
			...
			<?php 
                    $slider=array(
                            "slide1"=>"inc/images/master-slide-02.jpg",
                            "slide2"=>"inc/images/master-slide-03.jpg",
                            "slide3"=>"inc/images/master-slide-04.jpg"
                                );
                    $i=1;
                    foreach($slider as $sl=>$url){
                    echo"<div class=\"item-slick1 item".$i."-slick1\" style=\"background-image: url($url);\">
					<div class=\"wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170\">
						<span class=\"caption1-slide1 m-text1 t-center animated visible-false m-b-15\" data-appear=\"fadeInDown\">
					Best Sales ".date("Y")."</span>
			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="inc/images/banner-02.jpg" alt="IMG-BENNER">
					...
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="inc/images/banner-05.jpg" alt="IMG-BENNER">
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="inc/images/banner-03.jpg" alt="IMG-BENNER">
					...
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="inc/images/banner-07.jpg" alt="IMG-BENNER">
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="inc/images/banner-04.jpg" alt="IMG-BENNER">
					...
					<div class="block2 wrap-pic-w pos-relative m-b-30">
						<img src="inc/images/icons/bg-01.jpg" alt="IMG">
			...
			<div class="wrap-slick2">
				<div class="slick2">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
								<img src="inc/images/item-02.jpg" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative">
								<img src="inc/images/item-03.jpg" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative">
								<img src="inc/images/item-05.jpg" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
								<img src="inc/images/item-07.jpg" alt="IMG-PRODUCT">
			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
					<div class="hov-img-zoom pos-relative">
						<img src="inc/images/banner-08.jpg" alt="IMG-BANNER">
				...
				<div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
					<div class="bgwhite hov-img-zoom pos-relative p-b-20per-ssm">
						<img src="inc/images/shop-item-09.jpg" alt="IMG-BANNER">
	...
	<section class="instagram p-t-20">
		...
		<div class="flex-w">
			...
			<div class="block4 wrap-pic-w">
				<img src="inc/images/gallery-03.jpg" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="inc/images/gallery-07.jpg" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="inc/images/gallery-09.jpg" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="inc/images/gallery-13.jpg" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="inc/images/gallery-15.jpg" alt="IMG-INSTAGRAM">
