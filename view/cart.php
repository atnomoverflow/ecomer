...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(../inc/images/heading-pages-01.jpg);">
						...
						<tr class="table-row">
							<td class="column-1">
								<div class="cart-img-product b-rad-4 o-f-hidden">
									<img src="../inc/images/item-10.jpg" alt="IMG-PRODUCT">
								</div>
							</td>
