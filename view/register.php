...
if(session_id() == '') {
 ...
 <?php
  ...
  $stm = Model::$PDO->prepare("INSERT INTO mon_boutique.client(Pseudo,Nom,Prenom,Email, Telephone,adresse,genre,mp) VALUES (?,?,?,?,?,?,?,?)");
				$stm->execute(["ahmed","mtibaa","hmayda", "mohamedMtibaa@gmail.com", "45214521",
			"route de gabes","male","789456123"]);
